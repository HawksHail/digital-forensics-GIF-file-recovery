...
public class MainWindow {
	...
	public ArrayList<String> getDiskInformation() {
	...
	public void createBootBlock(JPanel blockPanel) {
	...
	public void createBlockGroup(JPanel blockPanel) {
		Dimension buttonDimension = new Dimension(140,70);
	...
	public void createBlockPanel(JPanel blockPanel) {
 ...
 //@TestOnly UnComment while running Test Class, make sure you uncomment / add the  org.jetbrains.annotations.TestOnly 'import' above as well
	public JTextPane getgDetailsText() {
		return gDetailsText;
	}

	//@TestOnly UnComment while running Test Class
	public JButton getgButtonZoomOut() {
		return gButtonZoomOut;
	}

	//@TestOnly UnComment while running Test Class
	public JButton getgButtonValidate() {
		return gButtonValidate;
	}

	//@TestOnly UnComment while running Test Class
	public JProgressBar getgProgressBar() {
		return gProgressBar;
	}

	//@TestOnly UnComment while running Test Class
	public int getgCurrentLevel() {
